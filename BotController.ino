...
void dumpGamepad(ControllerPtr ctl) 
{
    ...
    /*
    //slow down according to brake by up to half
    if(leftSpeed >= 0)
    {
      leftSpeed = leftSpeed - brake;
      if(leftSpeed < 0)//don't go below 0 so you don't reverse
      {
        leftSpeed = 0;
      }
    }
    ...
    {
      leftSpeed = leftSpeed + brake;
      if(leftSpeed > 0)//don't go above 0 so you don't go forward
      {
        leftSpeed = 0;
      }
    }
    ...
    if(rightSpeed >= 0)
    {
      rightSpeed = rightSpeed - brake;
      if(rightSpeed < 0)//don't go below 0 so you don't reverse
      {
        rightSpeed = 0;
      }
    }
    ...
    {
      rightSpeed = rightSpeed + brake;
      if(rightSpeed > 0)//don't go above 0 so you don't go forward
      {
        rightSpeed = 0;
      }
    }
